...
`,this.board=e.querySelector(".game-board"),this.label=e.querySelector(".loading-title")}setLoading(e){this.label&&(this.label.innerHTML=e?"<em>Loading...</em>":"Calculating...")}createView(e){let t=e.config.viewType;var i=e.config,i=(!(t=t||new URLSearchParams(location.search).get("view"))&&i.width&&i.height&&(i=i.width*i.height,t=65536<i?"canvas":16384<i?"webgl":1024<i?"svg":"html"),t=t||"html",this.parentElement);t&&i.setView&&(e.config.viewType=t,i.setView(t))}updateView(){}updateFPS(){}}k(166);class a extends HTMLElement{static views={};static addViewType(e,t,i,s){a.views[e]={label:t,icon:i,viewInit:s}}static get observedAttributes(){return["view","start","title","image","width","height","delay","scale","wrapped","engines"]}constructor(){super()}connectedCallback(){this.config(),this.render(this),this.start&&setTimeout(()=>this.game.start(),100);let s=()=>{this.dispatchEvent(new CustomEvent("game:updated",{detail:this}))},t={"game:updated":e=>{},"game:resize":e=>{var t,i=this.game&&this.game.resize(e.detail.width,e.detail.height);return!i&&((t=e.detail.event)&&(t.cancel=!0,t.cancelBubble=!0,t.stopPropagation()),t=e.detail.abort)&&t(),s(),i},"game:speed":e=>{e=Number(e.detail);this.delay=e,this.game&&(this.game.delay=e,this.game.started)&&(this.game.stop(),this.game.start(e)),this.setAttribute("delay",e),s()},"game:scale":e=>{this.scale=Number(e.detail)||1,this.scale&&(this.setAttribute("delay",this.scale),this.game.scale=this.scale,this.game.dataLoaded(this.game.data)),s()},"game:reset":()=>{this.game&&this.game.reset(),s()},"game:start":()=>{this.game&&this.game.start(),s()},"game:stop":()=>{this.game&&this.game.stop(),s()}};Object.keys(t).forEach(e=>{this.addEventListener(e,t[e])})}trigger(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t}))}attributeChangedCallback(e,t,i){var s="true"==i,a=0<=["start"].indexOf(e);if((a||""!==t)&&(a||null!==t)&&t!==i)switch(e){case"start":this.game&&(s&&!this.game.started?this.trigger("game:start"):!s&&this.game.started&&this.trigger("game:stop"));break;case"view":this.setView(i),this.toolbar.render(this.toolbar);break;case"title":this.toolbar.gameTitle(i);break;case"width":case"height":break;case"delay":this.delay!==i&&this.trigger("game:speed",i);break;case"scale":this.scale!==i&&this.trigger("game:scale",i)}}config(){this.viewType=this.getAttribute("view"),this.engineTypes=this.getAttribute("engines"),this.engineTypes&&(this.engines=JSON.parse(this.engineTypes)),this.start=this.getAttribute("start"),this.title=this.getAttribute("title"),this.image=this.getAttribute("image"),this.width=this.getAttribute("width"),this.height=this.getAttribute("height"),this.scale=this.getAttribute("scale"),this.delay=this.getAttribute("delay"),this.wrapped=this.getAttribute("wrapped"),this.locked=this.getAttribute("locked"),this.hideToolbar="false"==this.getAttribute("toolbar"),this.autoplay=this.getAttribute("autoplay"),this.explain=this.getAttribute("explain"),this.autoplay&&(this.start=!0)}render(e){this.view=this.viewType?this.getView(this.viewType):new i,this.game=this.game||new t(this,this.view),e.innerHTML="",this.hideToolbar||(this.toolbar=new c(this),this.toolbar.className="sticky left-0 top-0 right-0 z-10",e.appendChild(this.toolbar)),e.appendChild(this.view),this.locked||(e.classList.add("relative"),e.classList.add("overflow-auto")),this.game.view!=this.view&&(this.game.view=this.view)}getView(e){var t=a.views,i=Object.keys(t||{});if(!i.length)throw new Error("No view types registered. Nothing to display");e=(e=t[e]?e:null)?t[e]:t[i[0]];if(e)return e.viewInit();throw t=this.view||"default",new Error(`Game view type '${t}' not found. Available: `+i)}setView(e){var t=this.game.view,i=this.getView(e);this.viewType=e,i&&t&&(t.parentElement.replaceChild(i,t),this.game.view=i,this.game.dataLoaded(this.game.data))}}var s=k(770),r=k.n(s),s=k(651),n=k.n(s),s=k(564),o=k.n(s),s=k(716),l=k.n(s),s=k(372),h=k.n(s),s=k(443),d=k.n(s);k(581);class c extends HTMLElement{static{var e="game-toolbar",t=c;customElements.get(e)||customElements.define(e,t)}constructor(e){super(),this.parent=e,this.config=e||{}}connectedCallback(){this.render(this);let t={"game:updated":e=>this.update(e.detail),"game:fps":e=>this.gameFpsCounter(e.detail)};this.parent&&Object.keys(t).forEach(e=>{this.parent.addEventListener(e,t[e])})}render(e){let t=this.config;e.innerHTML=`    
  ...
  `,this.onClick(".game-reset",()=>this.trigger("game:reset")),this.onClick(".game-start",()=>this.trigger("game:start")),this.onClick(".game-stop",()=>this.trigger("game:stop")),this.onClick(".game-config",()=>{this.show_settigs=!this.show_settigs,this.gameSettings(t)}),this.gameEngine(t.engines),this.populateSettings(t),this.populateViewTypes(a.views),this.gameFpsCounter(0),this.update(t),this.onChanged(".game-width",e=>this.trigger("game:resize",{width:Number(e.target.value),height:t.height,event:e})),this.onChanged(".game-height",e=>this.trigger("game:resize",{width:t.width,height:Number(e.target.value),event:e})),this.onChanged(".game-delay",e=>this.trigger("game:speed",e.target.value)),this.inlineIncludeImages(e)}update(e){var t=e.game.started;this.gameTitle(e.title),this.gameDimentions(e),this.gameResetBtn(!t&&e.game&&e.game.generation),this.gameConfigBtn(!t),this.gameStartBtn(!t&&!e.locked),this.gameStopBtn(t&&!e.locked),this.gameSettings(e),t||this.gameFpsCounter(0)}onClick(e,t){e=this.querySelector(e);e&&e.addEventListener("click",t)}onChanged(e,t){e=this.querySelector(e);e&&e.addEventListener("change",t)}trigger(e,t){e=new CustomEvent(e,{bubbles:!0,detail:t});this.dispatchEvent(e)}gameEngine(e){var t=this.querySelector(".game-engine");if(t){t.innerHTML=`
    <button
        type="button"
...
`,this.gameEnginesButton=t.querySelector(".game-engines-btn"),this.gameEnginesMenu=t.querySelector(".game-engines-menu"),this.gameEnginesMenuItems=t.querySelector(".game-engines-menu-items");t=window.location.search;let s=new URLSearchParams(t).get("engine")||"latest";e&&e.length&&this.gameEnginesMenu&&(this.gameEnginesMenuItems.innerHTML="",this.gameEnginesButton.classList.add("cursor-pointer"),this.gameEnginesButton.classList.remove("cursor-default"),this.gameEnginesButton.onclick=()=>{this.gameEnginesMenu.classList.toggle("hidden")},e.forEach(e=>{var t=document.createElement("A"),i="flex space-x-2 px-2 py-1 cursor-pointer text-sm bg-white hover:bg-gray-100 dark:bg-gray-700 hover:dark:bg-gray-600",i=e==s?i+"font-bold text-gray-900 dark:text-white":i;t.setAttribute("role","menuitem"),t.className=i,t.onclick=()=>{this.updateQueryParams({engine:e},!0),this.gameEnginesMenu.classList.add("hidden")},t.innerHTML=`
        ...
        `,this.gameEnginesMenuItems.appendChild(t)}))}}gameTitle(e){var t=this.querySelector(".game-title");t&&(t.innerHTML=e||"Game of Life")}gameDimentions(e){let i=this.querySelector(".game-dimentions");var t;i&&(t=(e,t)=>{e=i.querySelector(e);e&&(e.innerHTML=t)},!e.locked&&e.width&&e.height?(t(".board-width",e.width),t(".board-height",e.height),i.classList.remove("hidden")):i.classList.add("hidden"))}gameFpsCounter(e){var t=this.querySelector(".game-fps-container"),i=this.querySelector(".game-fps");t&&(this.config.game.started&&!this.config.locked?(i.innerHTML=e,t.classList.remove("hidden")):t.classList.add("hidden"))}gameResetBtn(e){var t=this.querySelector(".game-reset");t&&(e&&!this.config.locked?t.classList.remove("hidden"):t.classList.add("hidden"))}gameConfigBtn(e){var t=this.querySelector(".game-config");t&&(e&&!this.config.locked?t.classList.remove("hidden"):t.classList.add("hidden"))}gameStartBtn(e){var t=this.querySelector(".game-start");t&&(e?t.classList.remove("hidden"):t.classList.add("hidden"))}gameStopBtn(e){var t=this.querySelector(".game-stop");t&&(e?t.classList.remove("hidden"):t.classList.add("hidden"))}gameSettings(e){var t=!e.game.started&&this.show_settigs,i=this.querySelector(".game-settings");i&&(t?i.classList.remove("hidden"):i.classList.add("hidden"),(t=(e,t)=>{e=this.querySelector(e);e&&(e.value=t)})("input.game-width",e.width),t("input.game-height",e.height),t("input.game-delay",e.delay))}populateSettings(e){var t=this.querySelector(".game-settings");t&&(t.innerHTML=`
...
`,this.board=e.querySelector(".game-board"),this.grid=e.querySelector(".game-grid"),this.container=e.querySelector(".game-container"),this.updateTheme()}setLoading(e){this.board&&(e?(console.debug("Loading board game into:",this),this.board.innerHTML="<em>Loading...</em>"):this.board.innerHTML="")}createView(i,s){var a=i.config,r=a.width,e=a.height,t=a.scale,n=this.board;if(n){n.style["aspect-ratio"]=r+" / "+e,t&&(n.style["min-width"]=r*t+"px",n.style["min-height"]=e*t+"px"),this.grid&&(this.grid.setAttribute("viewBox",`0 0 ${r} `+e),t)&&(this.grid.style["min-width"]=r*t+"px",this.grid.style["min-height"]=e*t+"px"),this.width=r,this.height=e,this.canvas=Array(r*e);for(let t=0;t<e;t++){var o=document.createElement("DIV");o.className="row",n.appendChild(o);for(let e=0;e<r;e++){var l=s[e+t*r]?1:0,h=document.createElement("DIV");h.id=e+"x"+t,h.setAttribute("value",l),h.onclick=this.handleClick(e,t,h),h.onmouseenter=this.handleOnEnter(e,t,h),o.appendChild(h),this.canvas[e+t*r]=h,a.explain&&i.getValue&&(l=i.getValue(e-1,t-1)+i.getValue(e,t-1)+i.getValue(e+1,t-1)+i.getValue(e-1,t)+i.getValue(e+1,t)+i.getValue(e-1,t+1)+i.getValue(e,t+1)+i.getValue(e+1,t+1),h.setAttribute("count",l))}}a.explain&&this.updateTransitions(a)}}updateTransitions(e){var t;this.custom_css||(this.custom_css=document.createElement("style"),this.shadow.appendChild(this.custom_css)),e.delay<=200?this.custom_css.innerHTML="":(t=Math.round(e.delay/2/100)/10,this.custom_css.innerHTML=`
      .game-board .row [count]:before { transition: all ease-in ${t}s; }
      .game-board .row [value] { transition: all ease-out ${t}s; }
      `),this.last_delay=e.delay}updateView(t,i){var s=t.config,a=s.width*s.height;for(let e=0;e<a;e++){var r,n,o=this.canvas[e];o&&(o.setAttribute("value",i[e]||0),s.explain)&&t.getValue&&(n=e%s.width,r=Math.floor(e/s.width),n=t.getValue(n-1,r-1)+t.getValue(n,r-1)+t.getValue(1+n,r-1)+t.getValue(n-1,r)+t.getValue(1+n,r)+t.getValue(n-1,r+1)+t.getValue(n,r+1)+t.getValue(1+n,r+1),o.setAttribute("count",n))}s.explain&&s.delay!==this.last_delay&&this.updateTransitions(s)}updateTheme(){this.container&&(document.body.classList.contains("dark")?this.container.classList.add("dark"):this.container.classList.remove("dark"))}paint(e,t,i){e=this.canvas[e+t*this.width];e&&e.setAttribute("value",i||0)}handleClick(e,t,i,s){return()=>{s="1"==i.getAttribute("value")?0:1,this.paint(e,t,s)}}handleOnEnter(t,i,s,a){return e=>{1===e.buttons&&(a="1"==s.getAttribute("value")?0:1,this.paint(t,i,a))}}}var s=k(390),m=k.n(s);class p extends e.BI{static{var e="view-svg-image",t=p;customElements.get(e)||customElements.define(e,t),a.addViewType("svg","SVG Image",()=>m(),()=>new p)}constructor(){super(),this.shadow=this.attachShadow({mode:"closed"}),this.root=this.shadow,this.observer=new MutationObserver(e=>{for(const t of e){if("attributes"!==t.type||"class"!==t.attributeName)return;this.updateTheme()}}),this.observer.observe(document.body,{attributes:!0})}disconnectedCallback(){this.observer.disconnect()}updateTheme(){this.board&&(document.body.classList.contains("dark")?this.board.classList.add("dark"):this.board.classList.remove("dark"))}render(e){e.innerHTML=`
    <style>
    .game-board {
      margin: 0 auto;
      display: flex;
