...
`,this.board=e.querySelector(".game-board"),this.grid=e.querySelector(".game-grid"),this.container=e.querySelector(".game-container"),this.updateTheme()}setLoading(e){this.board&&(e?(console.log("Loading board game into:",this),this.board.innerHTML="<em>Loading...</em>"):this.board.innerHTML="")}createView(e,i){var e=e.config,s=e.width,a=e.height,e=e.scale||1,r=(this.grid&&this.grid.setAttribute("viewBox",`0 0 ${s} `+a),this.board);if(r){r.style["min-width"]=s*e+"px",r.style["min-height"]=a*e+"px",r.style["aspect-ratio"]=s+" / "+a,this.width=s,this.height=a,this.canvas=Array(s*a);for(let t=0;t<a;t++){var n=document.createElement("DIV");n.className="row",r.appendChild(n);for(let e=0;e<s;e++){var o=i[e+t*s]?1:0,l=document.createElement("DIV");l.id=e+"x"+t,l.setAttribute("value",o),l.onclick=this.handleClick(e,t,l),l.onmouseenter=this.handleOnEnter(e,t,l),n.appendChild(l),this.canvas[e+t*s]=l}}}}updateView(e,t){var e=e.config,i=e.width*e.height;for(let e=0;e<i;e++){var s=this.canvas[e];s&&s.setAttribute("value",t[e]||0)}}updateTheme(){this.container&&(document.body.classList.contains("dark")?this.container.classList.add("dark"):this.container.classList.remove("dark"))}paint(e,t,i){e=this.canvas[e+t*this.width];e&&e.setAttribute("value",i||0)}handleClick(e,t,i,s){return()=>{s="1"==i.getAttribute("value")?0:1,this.paint(e,t,s)}}handleOnEnter(t,i,s,a){return e=>{1===e.buttons&&(a="1"==s.getAttribute("value")?0:1,this.paint(t,i,a))}}}var r=i(390),f=i.n(r);class w extends t.BI{static{customElements.define("view-svg-image",w),a.addViewType("svg","SVG Image",()=>f(),()=>new w)}constructor(){super(),this.shadow=this.attachShadow({mode:"closed"}),this.root=this.shadow,this.observer=new MutationObserver(e=>{for(const t of e){if("attributes"!==t.type||"class"!==t.attributeName)return;this.updateTheme()}}),this.observer.observe(document.body,{attributes:!0})}disconnectedCallback(){this.observer.disconnect()}updateTheme(){this.board&&(document.body.classList.contains("dark")?this.board.classList.add("dark"):this.board.classList.remove("dark"))}render(e){e.innerHTML=`
<style>
  .game-board {}  
  .game-cells {
    fill: #000;
