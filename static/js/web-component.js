...
`,this.board=e.querySelector(".game-board"),this.grid=e.querySelector(".game-grid"),this.container=e.querySelector(".game-container"),this.updateTheme()}setLoading(e){this.board&&(e?(console.log("Loading board game into:",this),this.board.innerHTML="<em>Loading...</em>"):this.board.innerHTML="")}createView(e,i){var e=e.config,s=e.width,a=e.height,e=e.scale||1,r=(this.grid&&this.grid.setAttribute("viewBox",`0 0 ${s} `+a),this.board);if(r){r.style["min-width"]=s*e+"px",r.style["min-height"]=a*e+"px",r.style["aspect-ratio"]=s+" / "+a,this.width=s,this.height=a,this.canvas=Array(s*a);for(let t=0;t<a;t++){var n=document.createElement("DIV");n.className="row",r.appendChild(n);for(let e=0;e<s;e++){var l=i[e+t*s]?1:0,o=document.createElement("DIV");o.id=e+"x"+t,o.setAttribute("value",l),o.onclick=this.handleClick(e,t,o),o.onmouseenter=this.handleOnEnter(e,t,o),n.appendChild(o),this.canvas[e+t*s]=o}}}}updateView(e,t){var e=e.config,i=e.width*e.height;for(let e=0;e<i;e++){var s=this.canvas[e];s&&s.setAttribute("value",t[e]||0)}}updateTheme(){this.container&&(document.body.classList.contains("dark")?this.container.classList.add("dark"):this.container.classList.remove("dark"))}paint(e,t,i){e=this.canvas[e+t*this.width];e&&e.setAttribute("value",i||0)}handleClick(e,t,i,s){return()=>{s="1"==i.getAttribute("value")?0:1,this.paint(e,t,s)}}handleOnEnter(t,i,s,a){return e=>{1===e.buttons&&(a="1"==s.getAttribute("value")?0:1,this.paint(t,i,a))}}}var r=i(416),w=i.n(r);class b extends t.BI{static{customElements.define("view-svg-image",b),a.addViewType("svg","SVG Image",()=>w(),()=>new b)}constructor(){super(),this.shadow=this.attachShadow({mode:"closed"}),this.root=this.shadow,this.observer=new MutationObserver(e=>{for(const t of e){if("attributes"!==t.type||"class"!==t.attributeName)return;this.updateTheme()}}),this.observer.observe(document.body,{attributes:!0})}disconnectedCallback(){this.observer.disconnect()}updateTheme(){this.board&&(document.body.classList.contains("dark")?this.board.classList.add("dark"):this.board.classList.remove("dark"))}render(e){e.innerHTML=`
<style>
  .game-board {}  
  .game-cells {
    fill: #000;
...
<div class="flex flex-col justify-start">
    ...
    `,this.board=e.querySelector(".game-board"),this.cells=e.querySelector(".game-cells"),this.updateTheme()}setLoading(e,t){}createView(e,i){var e=e.config,s=e.width,a=e.height,e=e.scale||1,t=this.board;if(t&&(t.setAttribute("viewBox",`0 0 ${s} `+a),t.style["min-width"]=s*e+"px",t.style["min-height"]=a*e+"px",this.cells)){this.cells.innerHTML="",this.width=s,this.height=a,this.canvas=Array(s*a);for(let t=0;t<a;t++){var r=t*s;for(let e=0;e<s;e++){var n=document.createElementNS("http://www.w3.org/2000/svg","rect"),l=i[e+t*s];n.setAttribute("x",e),n.setAttribute("y",t),n.setAttribute("width",1),n.setAttribute("height",1),n.style.display=l?"":"none",this.canvas[e+r]=n,this.cells.appendChild(n)}}}}updateView(e,t){var e=e.config,i=e.width*e.height;for(let e=0;e<i;e++){var s=this.canvas[e],a=t[e];s&&(s.style.display=a?"":"none")}}}var r=i(977),f=i.n(r);class y extends t.BI{static{customElements.define("view-image-canvas",y),a.addViewType("canvas","Image Canvas",()=>f(),()=>new y)}constructor(){super(),this.observer=new MutationObserver(e=>{for(const t of e){if("attributes"!==t.type||"class"!==t.attributeName)return;this.updateTheme()}}),this.observer.observe(document.body,{attributes:!0})}disconnectedCallback(){this.observer.disconnect()}updateTheme(){this.board&&(document.body.classList.contains("dark")?(this.fill="#FFF",this.board.classList.add("dark")):(this.fill="#000",this.board.classList.remove("dark")))}render(e){e.innerHTML=`
<style>
  .game-board {}  
  .game-cells {
    fill: #000;
